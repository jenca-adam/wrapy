...
ArchivedArticle=wrapy.WraPy('https://api.nytimes.com/svc/archive/v1/',api_type='combined',root_url_fstring='{}.json',arg_count=2,argmap={'api_key':'api-key'},api_key='6EbhSPRBcbXSEoAvz2r7wkALp0R9zNbX',enable_caching=True,cache_timeout=50000)
